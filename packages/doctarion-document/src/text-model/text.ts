...
/**
 * We store simple text as an array of graphemes to ease reasoning about the
 * text. For example moving the cursor left can be done by just subtracting one
 * from an index into the grapheme array.
 *
